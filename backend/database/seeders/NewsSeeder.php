    ...
    public function run(): void
    {
        ...
        $items = [
            [
                ...
                'body_en' => "CESD was established under the Faculty of Engineering, National University of Laos, to serve as a national hub for engineering testing, research, and industry collaboration.\n\nThe center's 11 laboratories cover chemical analysis, electron microscopy, X-ray analysis, high-voltage testing, solid forming, physical measurement, and electrical/electronic measurement, among others.",
                'body_lo' => "CESD ໄດ້ຮັບການສ້າງຕັ້ງຂຶ້ນພາຍໃຕ້ຄະນະວິສະວະກຳສາດ, ມະຫາວິທະຍາໄລແຫ່ງຊາດລາວ ເພື່ອເປັນສູນກາງລະດັບຊາດດ້ານການທົດສອບ, ຄົ້ນຄວ້າ ແລະ ການຮ່ວມມືກັບອຸດສາຫະກຳທາງດ້ານວິສະວະກຳ.",
            ...
            [
                ...
                'body_en' => 'The workshop introduced CESD\'s testing capabilities and equipment catalog to local industry partners, opening the door for contracted analysis and joint research projects.',
                'body_lo' => 'ກອງປະຊຸມຝຶກອົບຮົມນີ້ໄດ້ນຳສະເໜີຄວາມສາມາດດ້ານການທົດສອບ ແລະ ບັນຊີອຸປະກອນຂອງ CESD ໃຫ້ແກ່ຄູ່ຮ່ວມພັດທະນາທາງອຸດສາຫະກຳພາຍໃນ.',
            ...
            [
                ...
                'body_en' => 'See the Training page for the full course listing, schedule, and registration details.',
                'body_lo' => 'ເບິ່ງໜ້າການຝຶກອົບຮົມ ສຳລັບບັນຊີຫຼັກສູດ, ຕາຕະລາງ ແລະ ລາຍລະອຽດການລົງທະບຽນທັງໝົດ.',
